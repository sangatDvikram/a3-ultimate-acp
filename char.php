...
while ($sup = odbc_fetch_array($rs1))
	{
?>
<tr><td class="rankingc" style="text-align:center;"><?php if($sup['pnline'] == 1){echo "<img src='http://$_SERVER[SERVER_NAME]/images/status.png' title='online'>";}else{echo "<img src='http://$_SERVER[SERVER_NAME]/images/status-offline.png' title='offline'>";} echo $sup['c_id']; ?></td><td class="rankingc" style="text-align:center;"><?php echo $sup['c_sheadera']; ?></td><td class="rankingc" style="text-align:center;"><?php echo $sup['c_sheaderc']; ?></td><td class="rankingc" style="text-align:center;"><?php echo $sup['rb']; ?></td><td class="rankingc" style="text-align:center;"><?php echo $sup['c_status']; ?></td><td class="rankingc"><a href="http://www.a3ultimate.com/Admin/viewchar/<?php echo $sup['sr_no']; ?>/" title="View Character Info.">[VIEW]</a> <a href="http://www.a3ultimate.com/Admin/editchar/<?php echo trim($sup['c_id']); ?>/" title="Edit Character Information">[EDIT]</a> <a href="#" title="View Inventory">[INVENTORY]</a> </td><td class="rankingc"><a href="http://www.a3ultimate.com/Admin/ViewAccount/<?php echo $sup['c_sheadera']; ?>/" title="View Account Info.">[VIEW]</a> <a href="http://www.a3ultimate.com/Admin/EditAccount/<?php echo $sup['c_sheadera']; ?>/" title="Edit Account Information">[EDIT]</a> </td></tr>
<?php
}
?></table></td></tr>
</table>
