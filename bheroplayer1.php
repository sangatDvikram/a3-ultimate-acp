...
$shueinven = explode(";",$PETINV[1]);

$result = array();
$source = array_values($shueinven);
$count = count($source);
for($i = 0; $i < $count; $i +=4) 
{
  $result[] = $source[$i]+1;
            ...
            <table cellpadding="3" cellspacing='3' >                 
                ...
                <tr>
                    <?php
                        ...
                        $shuedata = shuedatacalc($shue);
                        print "<td style='cursor:pointer'><img src='$shuedata[Image]' class='thumbnail drevil' rel='drevil' data-trigger='hover' data-content=\"$shuedata[Msg]\"></td>";
