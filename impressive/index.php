...
$db_host = $cleardb_server; // Server Name
$db_user = $cleardb_username; // Username
$db_pass = $cleardb_password; // Password
$db_name = $cleardb_db; // Database Name
...
<body>
	<div class="container" unselectable="on">
		...
		<form class="addnewform" method="POST">
			...
			<center id="rad_buttons">
				...
				<label><input type="radio" name="company" id="BK" value="BK">
					...
					<input type="radio" name="company" value="Combined">Combined
			</center><br><br>
		...
		<br><br>
		<center>
			<h5><?php echo 'Cash Recieved = ' . $credit; ?></h5>
			...
			<input type="button" name="cash_recieved_btn" id="cash_recieved_btn" value="Cash recieved"></input>
		</center>
		...
		<td>'.$row['name'].'</td> -->
			...
			<tfoot>
				<tr>
					<th colspan="2">TOTAL<php? $account ?>
					</th>
