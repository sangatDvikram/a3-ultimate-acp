    ...
    <div class="container-fluid">
        ...
        { ?>
            <div class="row-fluid">
                ...
                <table width="960" border="0" cellspacing="0" cellpadding="5" style="border-collapse:collapse;"
                       align="center">

                    <form action=" " method="POST">
                        <tr>
                            <td class="forms" style="text-align:center;">
                                <p style="margin:0; padding:0; text-align:center">Enter your username below to recover
                                    password via your registered e-mail address.</p></td>
                        </tr>
                        <tr>
                            <td class="forms" align="center" style="text-align:center; margin-top:5px">
                                <input type="text" id="username" name="username" class="k-textbox" style="color:#000;"
                                       placeholder="Username" required validationMessage="Please enter a Username"/>

                            </td>
                        </tr>
                        <tr>
                            <td class="forms" align="center" style="text-align:center;">
                                <button class=" btn btn-large  btn-success" name="doRecover" type="submit"
        ...
        <?php } else
        {
            echo "<p style='text-align:center'>You are alredy loged in click here to go to <a href='ACP'><span class='label label-info'>ACP</span></acp></p>";
        } ?>
