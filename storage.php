...
<input type="text"  name="term"  class="span9" placeholder="Enter character name"  data-provide="typeahead" data-items="10" data-source='[""<?php $sqlstring1="select * from account ";
